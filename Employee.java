...
public class Employee extends User implements UserAuthentication {
    ...
    // ADD THESE TWO METHODS TO EMPLOYEE CLASS

public static Employee register(Scanner scanner, ArrayList<Customer> customers, ArrayList<Employee> existingEmployees, int idCounter) {
...
public static Employee authenticate(Scanner scanner, ArrayList<Employee> employees) {
    System.out.println("\n--- Employee Login ---");
    ...
    for (Employee e : employees) {
        if (e.getUsername().equals(username) && e.getPassword().equals(password)) {
            if (e.login()) {
                System.out.println("\nLogin successful! Welcome " + e.getName());
                return e;
            }
        }
    }
